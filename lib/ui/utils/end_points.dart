abstract class EndPoints {
  static String baseUrl = "final-project-2-bmmv.onrender.com";
  static String login = "/api/v1/users/login";
  static String register = "/api/v1/users/singup";
  static String allPosts = "/api/v1/posts";
